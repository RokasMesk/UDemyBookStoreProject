...
namespace BulkyWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
		...
		public IActionResult SummaryPOST()
		{
            ...
            {
                //it is a regular customer acc, need to capture payment
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            List<ShoppingCart> shoppingsCarts = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == orderHeader.ApplicationUserId).ToList();
            _unitOfWork.ShoppingCart.RemoveRange(shoppingsCarts);
            _unitOfWork.Save();
        ...
        private double GetPricedBasedOnQuantity(ShoppingCart sC)
        {
            if (sC.Count <= 50)
